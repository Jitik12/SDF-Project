...
<body>
  ...
  <section id="breakfast">
    <div class="scanner">
      <h1><span class="breakfast">Breakfast</span> Scanner</h1>
      ...
      if (isset($_POST['Eaten'])) {
        ...
        $sql = "SELECT * FROM attendence WHERE (pupil = '$pupil') AND (breakfast = true ) AND (date = '$date')";
      ...
      <?php
        ...
        $sql = "INSERT INTO `attendence`(`pupil`, `date`, `breakfast`) VALUES ('$pupil','$date',true)";
        $result = mysqli_query($conn, $sql);
