...
<body>
  ...
  <section id="dinner">
    <div class="scanner">
      <h1><span class="dinner">Dinner</span> Scanner</h1>
      ...
      if (isset($_POST['Eaten'])) {
        ...
        $sql = "SELECT * FROM attendence WHERE (pupil = '$pupil') AND (dinner = true ) AND (date = '$date')";
      ...
      <?php
        ...
        $sql = "INSERT INTO `attendence`(`pupil`, `date`, `dinner`) VALUES ('$pupil','$date',true)";
        $result = mysqli_query($conn, $sql);
